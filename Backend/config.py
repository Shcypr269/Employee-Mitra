...
# Action keywords for intent detection
# Maps action types to detection keywords with priority ordering
ACTION_KEYWORDS = {
    'file_ticket': [
        'file ticket', 'create ticket', 'raise ticket', 'log ticket', 
        'submit ticket', 'new ticket', 'ticket for', 'report issue',
        'issue with', 'problem with', 'not working', 'broken', 
        'error', 'bug', 'help with', 'laptop issue', 'vpn issue',
        'connectivity issue', 'software issue', 'hardware issue'
    ],
    'schedule_meeting': [
        'schedule', 'book', 'arrange', 'set up', 'organize', 'plan', 
        'meeting', 'call', 'conference', 'schedule meeting', 
        'book meeting', 'arrange meeting', 'meeting with'
    ],
    'request_software': [
        'request software', 'install software', 'need software', 
        'software request', 'application request', 'software access',
        'need access to', 'install application'
    ],
    'escalate_issue': [
        'escalate', 'urgent', 'critical', 'high priority', 
        'emergency', 'escalation', 'escalate issue', 'raise priority'
    ],
    'apply_leave': [
        'apply leave', 'request leave', 'time off', 'vacation', 
        'pto', 'holiday', 'leave application', 'days leave', 
        'days off', 'take leave', 'casual leave', 'sick leave'
    ],
    'update_documentation': [
        'update document', 'edit document', 'modify document', 
        'change document', 'documentation update', 'update doc',
        'change documentation', 'modify doc'
    ],
    # Keep your original actions too
